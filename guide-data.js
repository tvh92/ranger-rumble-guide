window.RANGER_GUIDE = {
  ...
  eventHeroOrder: ['Ratchet'],
  heroes: {
    Ratchet: {className: 'Allrounder', speed: 'Medium', rarity: 'Epic', color: '#F38A0E', eventOnly: true, render: false, portrait: false, weaponStats: 'Ratchet Burst Pistol', loadout: ['Burst Pistol', 'Blaster', 'Wrench Throw', 'WrenchThrow', 'WrenchThrow', 'Wrench', 'RatchetMelee', 'RYNO', 'Ryno']},
