...
return `<section class="mods-section" id="talents"><div class="talent-heading"><h3>Talent progression</h3><p>Select a talent node to inspect</p></div><div class="talent-tree" data-talent-tree data-hero="${safe(heroKey)}" data-active-talent="0" data-pinned-talent="0"><div class="talent-list" role="tablist" aria-label="${safe(displayHeroName(heroKey))} talent progression"><div class="talent-list-header" aria-hidden="true"><span>Level</span><span></span></div>${nodes}</div><div class="talent-detail" id="talent-detail-${norm(heroKey)}" role="tabpanel" aria-live="polite" aria-labelledby="talent-title-${norm(heroKey)}-0">${talentDetailMarkup(heroKey,0,mods[0],talentRequirements[0])}</div></div></section>`;
}
